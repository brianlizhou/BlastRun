...
class StageThree {
    ...
    public Scene init (int width, int height, Stage s) {
      ...
      //Obstacle Layer 3
        for(int i = -100001; i<1000; i+=250){
            createObstacle(obs1,i,550);}
      //Obstacle Layer 3
        for(int i = -100001; i<1000; i+=250){
            createObstacle(obs1,i,0);}
    ...
    public void step (double elapsedTime) {
    	if(rocket.getBoundsInLocal().intersects(WinStar.getBoundsInLocal())){
    	 ...
    	 for(ImageView o: obstacles){   	 
   		 ...
   		 if(o.getY() >= 150 || o.getY() < 340){  	
    	    		o.setX(o.getX() + 2.5*elapsedTime);
    	    		o.setY(o.getY() + 2.5*elapsedTime);
    	    		
    	    }
   		 else if(o.getY() == 350)
    	    	{  	
    	    		o.setX(o.getX() - 2*elapsedTime);	    	
    	    }
   		else if(o.getY() == 550)
    	{  	
    		o.setX(o.getX() + 2*elapsedTime);	    	
